...
@section('title_page','Promotion')

@section('card_title')
  <h5><i class="fa fa-tags"></i> Promotion</h5>
@endsection

@section('breadcrumb')
  @component('component.breadcrumb',['item'=>[['#','Setting',null],[route('promotionmt.index'),'Promotion','active']]])
  @endcomponent
@endsection
@section('content')
  <div class="row">
    <div class="col-12">
      <div class="btn-group" role="group" aria-label="Basic example">
        <a class="btn btn-success" data-toggle="tooltip" title="Add Promotion" href="{{route('promotionmt.create')}}"><i class="fa fa-plus"></i> Add</a>
      </div><br><br>
    </div>
    <div class="col-12">
      @component('component.table',['istfoot'=>0,'table_class'=>'text-center'])
        ...
        @foreach ($data as $value)
          <tr>
            ...
            <td>
              <form action="{{route('promotionmt.destroy',['promotionmt'=>$value->code])}}" method="post" name="delete{{$loop->index}}" id="delete{{$loop->index}}">{{csrf_field()}}{{method_field('DELETE')}}</form>
              <div class="btn-group" role="group" aria-label="Basic example">
