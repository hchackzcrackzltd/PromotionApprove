...
@section('card_title')
  <h5><i class="fa fa-check"></i> Add Approvel</h5>
@endsection

@section('breadcrumb')
  @component('component.breadcrumb',['item'=>[['#','Setting',null],[route('approvelmt.index'),'Approvel',null],[route('approvelmt.create'),'Add Approval','active']]])
  @endcomponent
@endsection
@section('content')
  <form action="{{route('approvelmt.store')}}" method="post">
    {{csrf_field()}}
  ...
  @endcomponent
  <textarea name="userall" class="d-none" required></textarea>
  <br>
  <div class="col-12 text-right">
