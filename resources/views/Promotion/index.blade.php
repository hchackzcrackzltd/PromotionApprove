...
@section('breadcrumb')
  @component('component.breadcrumb',['item'=>[[route('Dashboard'),'Dashboard',null],[route('promotion.index'),'Promotion Request','active']]])
  @endcomponent
@endsection
...
@section('content')
  ...
  <div class="col-12">
    ...
    <div class="row">
      ...
      <div class="input-group">
        ...
        <input type="text" name="exp[{{$loop->index}}][value]" class="form-control mform expen" id="expen" placeholder="Insert Value" data-inputmask="'alias':'decimal'">
      </div>
      </div>
      </div>
      @endforeach
    ...
    @component('component.table',['istfoot'=>true,'table_class'=>'text-center t2'])
      ...
      @slot('tfoot')
        <tr>
          ...
          <th id="caltotalexp"></th>
          <th id="caltotalexp_sfcp"></th>
        </tr>
        <tr>
  ...
  <textarea name="item" class="d-none" required></textarea>
  </div>
...
@section('script')
  $(function(){
    ...
    item=[],gtotal={avgpcs:0,avgbth:0,sfcpcs:0,sfcbth:0,glowth:0,tcomp:0,ts:0},totalexp=0;
    setTimeout(function() {
